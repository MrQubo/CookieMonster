...
CM.ConfigData.CPSMode = {label: ['Current Cookies Per Second', 'Average Cookies Per Second'], desc: 'Calculate times using base Cookies Per Second or Cookies Per Second with average Cookies Per Second from clicks', toggle: false};
